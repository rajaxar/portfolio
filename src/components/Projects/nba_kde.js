...
class NBAKDE extends Component {
    state = {
        ...
        stepText: {
            ...
            3: "<div style='font-size:1.7rem;'>And now performance <span style='color: #FDB36D; font-weight:500'>during the new contract</span>. <br/><br/>This distribution is a little different. But it shows that there's <span style='font-weight:500;'>more</span> players performing better in their new contract.</div>"
        },
        svg: null,
        x: null,
        y: null
